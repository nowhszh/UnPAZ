...
namespace {
    ...
    void printHelp() {
        ...
        cout << "\nUnPAZ <input file> <commands>\n\n"
             ...
             << "  UnPAZ D:\\Games\\BlackDesert\\live\\Paz\\pad00000.meta -l" << endl;
    }
...
int main(int argc, char **argv) {
    ...
    if (strcmp(SourcePath.extension().string().c_str(), ".meta") == 0) {
#else
...
#if defined(__linux__) || defined(__APPLE__)
    } else if (strcmp(SourcePath.extension().string().c_str(), ".paz") == 0) {
#else
